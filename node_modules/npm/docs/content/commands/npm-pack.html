...
current working directory as <code class="language-plaintext highlighter-rouge">&lt;name&gt;-&lt;version&gt;.tgz</code>, and then write
...
<p>The <code class="language-plaintext highlighter-rouge">--dry-run</code> argument will do everything that pack usually does without
