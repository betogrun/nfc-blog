...
<p>If the argument to <code class="language-plaintext highlighter-rouge">npm help</code> is not a known help topic, then it will
call <code class="language-plaintext highlighter-rouge">help-search</code>.  It is rarely if ever necessary to call this
command directly.</p>
