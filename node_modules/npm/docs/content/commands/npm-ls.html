...
<p>Positional arguments are <code class="language-plaintext highlighter-rouge">name@version-range</code> identifiers, which will
limit the results to only the paths to the packages named.  Note that
nested packages will <em>also</em> show the paths to the specified packages.
For example, running <code class="language-plaintext highlighter-rouge">npm ls promzard</code> in npm’s source tree will show:</p>
...
<p>When run as <code class="language-plaintext highlighter-rouge">ll</code> or <code class="language-plaintext highlighter-rouge">la</code>, it shows extended information by default.</p>
...
<p>Display only the dependency tree for packages in <code class="language-plaintext highlighter-rouge">dependencies</code>.</p>
...
<p>Display only the dependency tree for packages in <code class="language-plaintext highlighter-rouge">devDependencies</code>.</p>
...
<p>When “dev” or “development”, is an alias to <code class="language-plaintext highlighter-rouge">dev</code>.</p>

<p>When “prod” or “production”, is an alias to <code class="language-plaintext highlighter-rouge">production</code>.</p>
