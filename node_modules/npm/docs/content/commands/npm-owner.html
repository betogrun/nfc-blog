...
<p>If you have two-factor authentication enabled with <code class="language-plaintext highlighter-rouge">auth-and-writes</code> then
you’ll need to include an otp on the command line when changing ownership
with <code class="language-plaintext highlighter-rouge">--otp</code>.</p>
